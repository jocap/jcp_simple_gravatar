...
"http://github.com/jocap/jcp_simple_gravatar/blob/master/plugins/jcp_simple_gravatar/current/jcp_simple_gravatar.txt":http://github.com/jocap/jcp_simple_gravatar/blob/master/plugins/jcp_simple_gravatar/current/jcp_simple_gravatar.txt
...
@jcp_simple_gravatar@ for Textpattern is based on the "glx_gravatar":http://code.google.com/p/textpattern-plugins/wiki/GlxGravatar plugin by Patrick Kollitsch, and is licensed under the "GNU General Public License v2":http://www.gnu.org/licenses/old-licenses/gpl-2.0.html.
